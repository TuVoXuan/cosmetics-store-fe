	...
	const handleClick = () => {
		if (btnRef.current) {
			if (btnRef.current.classList.contains("border-2")) {
				...
				btnRef.current.classList.replace("dark:border-black-dark-2", "dark:border-primary-100");
			} else {
				...
				btnRef.current.classList.replace("dark:border-primary-100", "dark:border-black-dark-2");
			}
		}
	};
