...
export default function OrderStatus({ children, value }: Props) {
	...
	return (
		<h4
			className={clsx(
				"lg:text-paragraph-3 font-semibold shrink-0 cursor-pointer border-2 border-gray-accent rounded-4xl px-8 py-2 dark:border-black-dark-2 dark:text-light-100",
