	...
	return (
		<section className="space-y-[104px] md:space-y-[112px] xl:space-y-[144px]">
			...
			<div className="lg:bg-gray-accent lg:rounded-5xl lg:dark:bg-black-dark-2 dark:lg:rounded-5xl lg:relative">
				...
				<div
					className=" lg:mt-12 lg:mb-6 rounded-5xl md:py-4 lg:flex lg:justify-end bg-gray-accent lg:bg-transparent 
				dark:lg:bg-transparent lg:rounded-none dark:bg-black-dark-2 px-2 py-10 mt-10 lg:pt-12 lg:pb-6 lg:pr-6 
				lg:pl-0 xl:pt-6"
				>
					<HyggeImage
