		...
		>
			<div className="xl:flex xl:gap-x-[72px] xl:items-center">
				...
				<div className="hidden md:block md:mb-16 xl:mb-0 xl:w-[55%]">
					<div className="px-[84px] lg:px-[124px] lg:grid lg:grid-cols-4 lg:gap-x-6 xl:px-0">
						<ProductImage sale={20} className="mb-6 lg:col-span-3 xl:mb-0" />
				...
				{/* product info */}
				<div>
					<TitlePage className="mb-6 text-center md:mb-8 xl:text-left" subtitle="Bán chạy" title="Kem chống nắng" />

					<div className="flex items-center justify-center mb-10 gap-x-6 md:gap-x-8 xl:mb-12">
						<Badge isResponsive color="yellow_tertiary" title="SUN CARE" />
						<Price price={30} sale={20} />
					</div>
			...
			<div>
				...
				<div className="mt-8 text-paragraph-5 md:text-paragraph-4">
					...
					<p>
						Trường hợp da bị mụn là da dầu, rửa mặt sạch và vùng da bị mụn bằng sữa rửa mặt Vinatid để loại sạch dầu
						trươc khi thoa Megaduo plus Gel
					</p>
					<p>
						<br />
					</p>
