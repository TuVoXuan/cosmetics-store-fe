	...
	return (
		...
		>
			<div className="lg:flex lg:gap-x-[72px] lg:items-center">
				...
				<div className="hidden md:block md:mb-16 lg:mb-0 lg:w-[55%]">
					<div className="px-[84px] lg:px-0">
						<ProductImage src={currItem?.thumbnail || "/images/Product.png"} className="mb-6 " />
			...
			<div>
				...
				/>
				<div
					className="mt-8 space-y-4 text-paragraph-4 md:text-paragraph-2 dark:!text-white"
					dangerouslySetInnerHTML={{
						__html: productInfo.descriptions.find((des) => des.language === locale)?.value || "",
					}}
				></div>
			</div>
